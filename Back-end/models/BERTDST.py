...
class BERTDST(BERTDSTMain):
    ...
    def forward(
        ...
        **kwargs
        ...
        if get_output_for_metrics_end:
            ...
            loss = self.compute_loss((model_out, gate_logits, span_logits), extra_info, accel)
    ...
    def get_output_for_metrics(
        ...
        **kwargs
        ...
        outs = super(BERTDST, self).get_output_for_metrics(model_out, items, len(extra_info), extra_info, should_return=True)
